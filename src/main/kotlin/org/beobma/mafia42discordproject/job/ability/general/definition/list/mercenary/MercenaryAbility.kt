...
class MercenaryAbility : ActiveAbility, JobUniqueAbility {
    ...
    override val description: String = "게임 시작 시 시민 팀 플레이어 한 명이 의뢰인으로 지정되며 낮이 될 때 의뢰를 받는다. 의뢰를 받은 후 의뢰인이 밤에 살해당할 경우, 밤마다 플레이어 한 명을 처형할 수 있게 된다."
    override val image: String = "https://lsvptosgnbwgsteuwstf.supabase.co/storage/v1/object/public/mafia/mercenary_ability.webp"
