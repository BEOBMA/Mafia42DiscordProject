...
import org.beobma.mafia42discordproject.job.ability.general.definition.list.doctor.Heal
...
class Doctor : Job(), Definition {
    ...
    override val abilities: MutableList<JobUniqueAbility> = mutableListOf(Heal())
}
