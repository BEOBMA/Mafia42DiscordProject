...
import org.beobma.mafia42discordproject.job.ability.general.definition.list.reporter.Embargo
...
class Reporter : Job(), Definition {
    ...
    override val abilities: MutableList<JobUniqueAbility> = mutableListOf(ReporterAbility(), Embargo())

    var selectedTargetId: Snowflake? = null
    var discoveredActualJobName: String? = null
    var discoveredJobName: String? = null
    var discoveredImageUrl: String? = null
    var articlePublishDay: Int? = null
    var articlePublishAtNightMidpoint: Boolean = false
