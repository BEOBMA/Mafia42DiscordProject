...
class Vigilante : Job(), Definition {
    ...
    override val description: String = "[숙청] 게임 당 한 번, 낮에 플레이어 한 명을 선택해 마피아 여부를 알아낼 수 있으며 밤에 알고 있는 적팀을 처형할 수 있다. (1회용)"
    override val jobImage: String = "https://lsvptosgnbwgsteuwstf.supabase.co/storage/v1/object/public/mafia/mafia%20(83).webp"
