...
object GameLoopManager {
    ...
    suspend fun startNightPhase(game: Game) {
        ...
        game.setMainChannerTitleName("${game.dayCount}일차 밤")
        game.sendMainChannerImage("https://cdn.discordapp.com/attachments/1483977619258212392/1483978042673070342/43e6c3860a090af9.png?ex=69bc8dc0&is=69bb3c40&hm=1739d48aa9a9598a28916ad594db053d55da281de09550f977f62d111076fd7a&")
